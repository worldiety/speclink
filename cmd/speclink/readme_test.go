...
func TestReadmeListsEveryRule(t *testing.T) {
	...
	rules := []string{
		...
		"K13-SOURCE-DRIFT",
		"K14-REQ-UNVERIFIED",
		"K15-EVENT-NO-TRANSITION",
		"K16-PROCESS-NO-START",
		"K16-PROCESS-NO-END",
		"K16-PROCESS-NO-ACTIVITY",
		"K16-NODE-DUPLICATE",
		"K16-EDGE-DANGLING",
		"K16-NODE-DEGREE",
		"K16-CHOICE-UNCONDITIONAL",
		"K16-NODE-UNREACHABLE",
		"K16-NODE-TRAPPED",
		"K16-NODE-REF-UNKNOWN",
		"K16-PROCESS-UNBOUND",
		"K16-PROCESS-DUPLICATE",
		"K16-WORK-OUTSIDE-PROCESS",
		"K16-EVENT-UNPLACED",
		"K19-TOPIC-DUPLICATE",
		"K19-TOPIC-UNUSED",
		"K17-CHANNEL-ENDPOINT-UNKNOWN",
		"K17-CHANNEL-INCOMPLETE",
		"K17-CHANNEL-UNBOUND",
		"K17-PARTICIPANT-UNUSED",
		"K17-PARTICIPANT-DUPLICATE",
		"K17-ADAPTER-NO-CHANNEL",
		"K15-TRANSITION-UNKNOWN",
		"K14-VERIFICATION-STALE",
		"K6-ADAPTER-WIRED-IN-CMD",
		"K6-PRESENTATION-NO-BUNDLE",
		"K6-CTX-NO-PRESENTATION-IMPORT",
		"K6-CTX-PRESENTATION-PKG",
		"K3-REQ-UNCOVERED",
		"K3-ABSTRACT-COVERED",
